...
router.get('/update/:id', isAuth, checkRole('user'), listController.getUpdate);
router.post('/update/:id', isAuth, checkRole('user'), listController.update);

router.post('/delete', isAuth, checkRole('user'), listController.delete);
